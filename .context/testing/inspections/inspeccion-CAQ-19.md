...
| :--- | :--- | :--- | :--- |
| CAQ-19-D1 | Contradicción técnica | Se exige unicidad, pero la validación documentada no es transaccional. | Hacer verificable una garantía atómica en persistencia. |
| CAQ-19-D2 | Completitud | No se define el texto literal ni accesibilidad del conflicto. | Acordar mensaje y anuncio de la actualización. |
| CAQ-19-D3 | Caso borde | No se define cuánto se conservan los datos ni si la unicidad cubre otros canales. | Acordar ciclo de vida y alcance global. |
...
| :--- | :--- |
| Escenarios y riesgo técnico | `.context/PBI/epics/EPIC-CAQ-8-pagina-publica-y-auto-reserva/stories/STORY-CAQ-19-conflicto-de-reserva-concurrente/story.md` |
